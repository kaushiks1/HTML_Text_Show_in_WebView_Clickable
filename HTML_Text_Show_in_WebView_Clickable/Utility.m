...
{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setObject:stringAuthToken forKey:@"auth_token"];
    [userDefaults synchronize];
}
...
{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    return [userDefaults objectForKey:@"auth_token"];
}
...
{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
//    [userDefaults setBool:NO forKey:@"isBGPPlanRegisterFilled"];
...
+ (NSMutableDictionary *)getValueFromJsonFile_FileName:(NSString *)stringFileName FileType:(NSString *)stringFileType
{
    ...
    NSError *anError;
    //    NSMutableArray *arrayJSON = [NSJSONSerialization JSONObjectWithData:aData options:kNilOptions error:&anError];
